...
namespace Tracy
{
    public class ExcelClass
    {
        ...
        public void ExportBatchDetailToExcel(string batchNo, string modelNo, string modelName, string subAssyNo, string subAssyName, 
            ...
            DateTime inputTime, DateTime outputTime, string remark, DataTable dtOperator, DataTable dtParts, DataTable dtSubMaterial)
        {
            try
            {
                ...
                string[] titleAry = { "Tracability Data Sheet", "General info:", "Operator info:", "Parts info:", "Sub Material info:" };
